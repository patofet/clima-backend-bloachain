...
docker run -d  --name melchor --restart=always -v ~/SmartChain/data:/opt/besu/data -v ~/SmartChain/config:/opt/besu/config -p 8545:8545 -p 9545:9545 -p 8546:8546 -p 30303:30303 -p 30303:30303/udp melchor --logging=INFO --min-gas-price=0 --data-path=/opt/besu/data --genesis-file=/opt/besu/genesis.json --node-private-key-file=/opt/besu/key --rpc-http-enabled --graphql-http-enabled --rpc-http-host=0.0.0.0 --rpc-http-port=8545 --rpc-ws-enabled --rpc-ws-host=0.0.0.0 --rpc-ws-port=8546 --p2p-port=30303 --host-whitelist=* --rpc-http-cors-origins=* --rpc-http-api=ADMIN,ETH,NET,IBFT,WEB3 --rpc-ws-api=ADMIN,ETH,NET,IBFT,WEB3 --nat-method=DOCKER --metrics-enabled --metrics-port=9545
...
docker run -d  --name gaspar --restart=always -v ~/SmartChain/data:/opt/besu/data -v ~/SmartChain/config:/opt/besu/config -p 8545:8545 -p 9545:9545 -p 8546:8546 -p 30303:30303 -p 30303:30303/udp gaspar --logging=INFO --min-gas-price=0 --data-path=/opt/besu/data --genesis-file=/opt/besu/genesis.json --node-private-key-file=/opt/besu/key --rpc-http-enabled --graphql-http-enabled --rpc-http-host=0.0.0.0 --rpc-http-port=8545 --rpc-ws-enabled --rpc-ws-host=0.0.0.0 --rpc-ws-port=8546 --p2p-port=30303 --host-whitelist=* --rpc-http-cors-origins=* --rpc-http-api=ADMIN,ETH,NET,IBFT,WEB3 --rpc-ws-api=ADMIN,ETH,NET,IBFT,WEB3 --nat-method=DOCKER --metrics-enabled --metrics-port=9545
...
mkdir /home/dappnode/SmartChain/data/config
chmod 777 -R /home/dappnode/SmartChain
docker build -t baltasar --build-arg PKEY=node1Key -f Dockerfile .
docker run -d  --name baltasar --restart=always -v ~/SmartChain/data:/opt/besu/data -v ~/SmartChain/config:/opt/besu/config -p 8545:8545 -p 9545:9545 -p 8546:8546 -p 30303:30303 -p 30303:30303/udp baltasar --logging=INFO --min-gas-price=0 --data-path=/opt/besu/data --genesis-file=/opt/besu/genesis.json --node-private-key-file=/opt/besu/key --rpc-http-enabled --graphql-http-enabled --rpc-http-host=0.0.0.0 --rpc-http-port=8545 --rpc-ws-enabled --rpc-ws-host=0.0.0.0 --rpc-ws-port=8546 --p2p-port=30303 --host-whitelist=* --rpc-http-cors-origins=* --rpc-http-api=ADMIN,ETH,NET,IBFT,WEB3 --rpc-ws-api=ADMIN,ETH,NET,IBFT,WEB3 --nat-method=DOCKER --metrics-enabled --metrics-port=9545
